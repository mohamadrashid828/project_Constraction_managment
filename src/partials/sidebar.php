...
<nav class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <?php if (in_array('data_entry', $permissions) || in_array('project_settings', $permissions)): ?>
            <li class="<?php echo $activePage === 'analytics' ? 'active' : ''; ?>"><a href="analytics.php"><i class="fas fa-chart-line"></i> Analysis</a></li>
        <?php endif; ?>
        <?php if (in_array('project_settings', $permissions) || in_array('user_management', $permissions)): ?>
